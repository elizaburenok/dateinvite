 ...
 *
 * Концы здесь важнее середины. В начале карточки лежат стопкой и обязаны
 * тронуться без рывка — нулевая производная это и даёт; в конце барабан должен
 * встать, а не воткнуться. Односторонние кривые сюда не годятся: ease-out
 * трогается с полной скорости (рывок на первом кадре), ease-in копит скорость к
 * концу и барабан приезжает с ударом.
 */
